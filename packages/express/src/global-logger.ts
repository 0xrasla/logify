 ...
 */
export function debug(input: string | Partial<Parameters<ILogger['debug']>[0]>): void {
 ...
 * @param input Log message or log entry
 */
export function info(input: string | Partial<Parameters<ILogger['info']>[0]>): void {
 ...
 * @param input Log message or log entry
 */
export function warn(input: string | Partial<Parameters<ILogger['warn']>[0]>): void {
 ...
 * @param input Log message or log entry
 */
export function error(input: string | Partial<Parameters<ILogger['error']>[0]>): void {
